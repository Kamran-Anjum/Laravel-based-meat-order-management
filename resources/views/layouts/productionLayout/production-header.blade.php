                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand d-block d-md-none" href="index.html">
                        ...
                        <b class="logo-icon">
                            ...
                            <!-- Dark Logo icon -->
                            <!-- <img src="{{ asset('images/backend-images/logos/logo-icon.png') }}" alt="homepage" class="dark-logo" /> -->
                            <!-- Light Logo icon -->
                            <!-- <img src="{{ asset('images/backend-images/logos/logo-light-icon.png') }}" alt="homepage" class="light-logo" /> -->
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span class="logo-text" style="font-size: 30px;">HalalMeat(Production)
                             <!-- dark Logo text -->
                             <!-- <img src="{{ asset('images/backend-images/logos/logo-text.png') }}" alt="homepage" class="dark-logo" /> -->
                             <!-- Light Logo text -->    
                             <!-- <img src="{{ asset('images/backend-images/logos/logo-light-text.png') }}" class="light-logo" alt="homepage" /> -->
                        </span>
                    </a>
                    ...
                    <ul class="navbar-nav float-left mr-auto">
                        ...
                        <li class="nav-item border-right">
                            <a class="nav-link navbar-brand d-none d-md-block" href="{{ url('admin/dashboard') }}">
                                ...
                                <!--End Logo icon -->
                                <!-- Logo text -->
                                <span class="logo-text" style="font-size: 30px;">HalalMeat
                                     <!-- dark Logo text -->
                                     <!-- <img src="{{ asset('images/backend-images/logos/logo-text.png') }}" alt="homepage" class="dark-logo" /> -->
                                     <!-- Light Logo text -->    
                                     <!-- <img src="{{ asset('images/backend-images/logos/logo-light-text.png') }}" class="light-logo" alt="homepage" /> -->
                                    ...
                                    <li>
                                        <div class="message-center message-body">
                                            ...
                                            <a href="javascript:void(0)" class="message-item">
                                                <span class="user-img"> <img src="{{ asset('images/backend-images/users/1.jpg') }}" alt="user" class="rounded-circle"> <span class="profile-status online pull-right"></span> </span>
                                            ...
                                            <!-- Message 
                                            <a href="javascript:void(0)" class="message-item">
                                                <span class="user-img"> <img src="{{ asset('images/backend-images/users/2.jpg') }}" alt="user" class="rounded-circle"> <span class="profile-status busy pull-right"></span> </span>
                                                <span class="mail-contnet">
                                            ...
                                            <!-- Message
                                            <a href="javascript:void(0)" class="message-item">
                                                <span class="user-img"> <img src="{{ asset('images/backend-images/users/3.jpg') }}" alt="user" class="rounded-circle"> <span class="profile-status away pull-right"></span> </span>
                                                <span class="mail-contnet">
                                                    <h5 class="message-title">Arijit Sinh</h5> <span class="mail-desc">I am a singer!</span> <span class="time">9:08 AM</span> </span>
                                            </a>
                                            <!-- Message
                                            <a href="javascript:void(0)" class="message-item">
                                                <span class="user-img"> <img src="{{ asset('images/backend-images/users/4.jpg') }}" alt="user" class="rounded-circle"> <span class="profile-status offline pull-right"></span> </span>
                                                <span class="mail-contnet">
                                        ...
                                        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                            <div class="carousel-inner" role="listbox">
                                                <div class="carousel-item active">
                                                    <div class="container p-0"> <img class="d-block img-fluid" src="{{ asset('images/backend-images/big/img1.jpg') }}" alt="First slide"></div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container p-0"><img class="d-block img-fluid" src="{{ asset('images/backend-images/big/img2.jpg') }}" alt="Second slide"></div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container p-0"><img class="d-block img-fluid" src="{{ asset('images/backend-images/big/img3.jpg') }}" alt="Third slide"></div>
                                                </div>
                                            </div>
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <span class="ml-2 user-text font-medium">Halalmeat</span><span class="fas fa-angle-down ml-2 user-text"></span>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                ...
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="{{ url('/production-logout') }}"><i class="fa fa-power-off mr-1 ml-1"></i> Logout</a>
                            </div>
                        </li>
                        <!-- ============================================================== -->
                        <!-- User profile and search -->
