                    ...
                    <ul id="sidebarnav">
                        <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item">
                                    <a href="{{ url('/packing-logout') }}" class="sidebar-link">
                        ...
                        <li class="sidebar-item">
                            <a href="{{ url('/packing/dashboard')}}" class="sidebar-link">
                                <i class="mdi mdi-av-timer"></i>
                                <span class="hide-menu">Packing Dashboard</span>
                            </a>
                        </li>
                        <!-- First menu  start -->
                        <li class="sidebar-item">
                            <a class="sidebar-link has-arrow waves-effect waves-dark" href="#" aria-expanded="false">
                                ...
                                <span class="hide-menu">Packing Sales Orders</span> 
                                <span class="badge badge-inverse badge-pill ml-auto mr-3 font-medium px-2 py-1"></span>
                            </a>
                            <ul aria-expanded="false" class="collapse  first-level">

                                <li class="sidebar-item">
                                    <a href="{{ url('packing/view-orders') }}" class="sidebar-link">
                                        <i class="mdi mdi-adjust"></i>
                                        <span class="hide-menu">View Kjottsentralen Orders</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a href="{{ url('/packing/view-wp-orders') }}" class="sidebar-link">
                                        <i class="mdi mdi-adjust"></i>
