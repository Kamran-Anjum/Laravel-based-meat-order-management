...
@include('layouts.financeLayout.finance-header')
@include('layouts.financeLayout.finance-sidebar')



@yield('content')

@include('layouts.financeLayout.finance-footer')
</div>
