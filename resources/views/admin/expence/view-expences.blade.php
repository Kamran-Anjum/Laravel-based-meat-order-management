            ...
            <div class="page-breadcrumb">
                ...
                <div class="row">
                    <div class="col-12">
					    ...
					    <a href="{{ url('admin/add-expence') }}"><button type="button" class="btn waves-effect waves-light btn-success">Add New</button></a> 
					</div>
                    </div>
                </div>
                                    ...
                                    <table id="zero_config" class="table table-striped border">
                                        ...
                                        @foreach($expences as $expence)
                                            <tr>
                                                <td>{{$i}}</td>
                                                <td>{{$expence->name}}</td>
                                                <td>{{$expence->typeName}}</td>
                                                <td>{{$expence->amount}}</td>
                                                                  <td>
                                                @if(!empty($expence->image))

                                                <img width="40px" height="40px" src=" {{ asset('/images/backend-images/halalmeat/expence/tiny/'.$expence->image ) }}">
                                                @else
                                                <img src=" {{ asset('/images/backend-images/invlogo.png' ) }}">
                                                @endif
                                                </td>
