            ...
            <div class="page-content container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form enctype="multipart/form-data" method="post" action="{{ url('/admin/edit-rider/'.$users->id) }}" > {{ csrf_field() }}
                                    <div class="form-body">
                                      ...
                                      <div class="row">
                                              <div class="col-md-4 mb-0">
                                                <div class="form-group">                                                  
                                                    ...
                                                    <input type="text" value="{{$users->roles->first()->name}}" class="form-control" name="customer_role" readonly>                                                    
                                                    <div class="invalid-feedback">Example invalid custom select feedback</div>
                                                </div>
                                            </div>
                                             <!-- <div class="col-md-4 mb-0">
