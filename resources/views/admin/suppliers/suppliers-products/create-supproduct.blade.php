            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-xs-12 align-self-center">
                        <h5 class="font-medium text-uppercase mb-0">Add Products To Supplier</h5>
                    </div>
                    <div class="col-lg-9 col-md-8 col-xs-12 align-self-center">
                        ...
                        <nav aria-label="breadcrumb" class="mt-2 float-md-right float-left">
                            <ol class="breadcrumb mb-0 justify-content-end p-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Add Products To Supplier</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="page-content container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form enctype="multipart/form-data" method="post" action="{{ url('/admin/create-supplier-product/'.$supplier->id) }}" > {{ csrf_field() }}
                                    <div class="form-body">
                                        <h5 class="card-title">Create Supplier Products</h5>
                                        <hr>
                                        ...
                                        <div class="row">
                                             <div class="col-md-4 mb-0">
                                                <div class="form-group">                                                  
                                                    ...
                                                    <input readonly="" type="text" class="form-control" value="{{$supplier->supplier_name}}" name="">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 mb-0">
                                                <div class="form-group">                                                  
                                                    ...
                                                    <select name="supp_products[]" id="suppproducts" class="form-control select2" multiple="" style="width: 100%; height:36px;" required>
                                                        @foreach($products as $product)
                                                        <option value="{{$product->id}}">{{$product->name}} ({{$product->catName}})</option>
                                                        @endforeach
                                            </select>                                                  
                                                    <div class="invalid-feedback">Example invalid custom select feedback</div>
                                                </div>
