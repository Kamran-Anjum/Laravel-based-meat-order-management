            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-xs-12 align-self-center">
                        <h5 class="font-medium text-uppercase mb-0">List Suppliers</h5>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <a href="{{ url('admin/create-supplier') }}"><button type="button" class="btn waves-effect waves-light btn-success">Add New</button></a>
                    </div>
                    </div>
                </div>
                                    ...
                                    <table id="zero_config" class="table table-striped border">
                                        ...
                                        @foreach($suppliers as $supplier)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="button-group">
                                                        <!-- <button type="button" class="btn waves-effect waves-light btn-info"><a class="text-white" href="{{ url('/admin/view-fabrics')}}">Supplier Details</a></button> -->
  ...
  <div class="card">
    ...
    <div class="card-header" role="tab" id="headingOne1">
      <a data-toggle="collapse" data-parent="#accordionEx" href="#collapseOne1" aria-expanded="true"
        ...
        <h5 class="mb-0">
          Collapsible Supplier Detail<i class="fas fa-angle-down rotate-icon"></i>
        </h5>
      </a>
    </div>
