            ...
            <div class="page-content container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form enctype="multipart/form-data" method="post" action="{{ url('/admin/update-wp-order/'.$sale_order->wp_order_id) }}" > {{ csrf_field() }}
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <select id="order_status" name="dept_status" class="form-control">
                                                        {!!$location_dropdown !!}
                                                    </select>
                                                </div>
                                            </div>
