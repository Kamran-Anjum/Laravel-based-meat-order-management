    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-lg-3 col-md-4 col-xs-12 align-self-center">
                <h5 class="font-medium text-uppercase mb-0">Add Coupons</h5>
            </div>
    ...
    <div class="page-content container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <form class="form-horizontal" method="post" action="{{ url('/admin/create-coupon') }}" name="add_coupon" id="add_coupon"> {{ csrf_field() }}
                            <div class="form-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input required type="text" id="coupon_name" name="coupon_name" class="form-control" placeholder="" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input required type="text" id="coupon_code" name="coupon_code" class="form-control" placeholder="" minlength="5" maxlength="15" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="amount" name="amount" class="form-control" placeholder="" min="1" required> 
                                        </div>
                                    </div>
                                </div>
