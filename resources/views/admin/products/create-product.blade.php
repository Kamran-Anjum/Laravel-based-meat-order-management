            ...
            <div class="page-content container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form enctype="multipart/form-data" method="post" action="{{ url('/admin/create-product') }}" > {{ csrf_field() }}
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-0">
                                                <div class="form-group">                                                  
                                                    ...
                                                    <select name="subcategory[]" id="subcategory" class="form-control select2" multiple="" disabled="" style="width: 100%; height:36px;" required>
                                            </select>                                                  
                                                    <div class="invalid-feedback">Example invalid custom select feedback</div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-0">
                                                <div class="form-group">                                                  
                                                    ...
                                                    <input type="text" class="form-control" name="sku_number">
                                                    <div class="invalid-feedback">Example invalid custom select feedback</div>
                                                </div>
                                            </div>
                                        </div>
