        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-xs-12 align-self-center">
                        <h5 class="font-medium text-uppercase mb-0">Create E-Gift Card</h5>
                    ...
                    <div class="col-lg-8 col-md-4 col-xs-12 align-self-center">
                        ...
                        <nav aria-label="breadcrumb" class="mt-2 float-md-right float-left">
                            <ol class="breadcrumb mb-0 justify-content-end p-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Create E-Gift Card</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="page-content container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form enctype="multipart/form-data" method="post" action="{{ url('/admin/create-egiftcards') }}" name="" id=""> {{ csrf_field() }}
                            <h4 class="card-title">Add New E-Gift Card</h4>
                            <form class="needs-validation" novalidate>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="card_code" value="600">
                                ...
                                <button type="" class="btn btn-dark"><a class="text-white" href="{{ url('/admin/view-egiftcards')}}"><i class="fa fa-times"></i> Cancel</a></button>
