            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-xs-12 align-self-center">
                        <h5 class="font-medium text-uppercase mb-0">List Orders with Status</h5>
                    ...
                    <div class="col-lg-8 col-md-4 col-xs-12 align-self-center">
                        ...
                        <nav aria-label="breadcrumb" class="mt-2 float-md-right float-left">
                            <ol class="breadcrumb mb-0 justify-content-end p-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">List Orders with Status</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                        ...
                        <div class="material-card card">
                            <div class="card-body">
                                ...
                                <tr>
                                   ...
                                   <td>{{ $orderstatusget[$i] }}</td>
                                    <td><u><a class="text-dark" href="/order-details/{{ $order->shiporder }}">View Details</a></u></td>
                                </tr>
                                <?php $i = $i+1; ?>
                                @endforeach
