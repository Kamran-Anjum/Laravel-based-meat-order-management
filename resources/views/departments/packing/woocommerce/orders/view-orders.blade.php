                                        ...
                                        @foreach($db_wp_orders as $order)
                                            <tr>
                                                ...
                                                <td style="width: 15%">
                                                    ...
                                                    @if($order->location_status != 3)
                                                    <button type="button" disabled class="btn waves-effect waves-light btn-primary"><a class="text-white">Forward</a></button>
                                                    @else
                                                    <button type="button" class="btn waves-effect waves-light btn-primary"><a class="text-white" href="{{ url('packing/forward-order/'.$order->id) }}">Forward</a></button>
                                                    @endif
