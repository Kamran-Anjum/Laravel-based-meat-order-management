            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-xs-12 align-self-center">
                        <h5 class="font-medium text-uppercase mb-0">Add Monogram Location Type</h5>
                    </div>
                    <div class="col-lg-9 col-md-8 col-xs-12 align-self-center">
                        ...
                        <nav aria-label="breadcrumb" class="mt-2 float-md-right float-left">
                            <ol class="breadcrumb mb-0 justify-content-end p-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Add Monogram Location Type</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="page-content container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form enctype="multipart/form-data" method="post" action="{{ url('/admin/create-monogramlocation') }}" name="add_monogramlocation" id="add_monogramlocation"> {{ csrf_field() }}
                                    <div class="form-body">
