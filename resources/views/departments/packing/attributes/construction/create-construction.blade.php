            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-xs-12 align-self-center">
                        <h5 class="font-medium text-uppercase mb-0">Add Construction</h5>
                    </div>
                    <div class="col-lg-9 col-md-8 col-xs-12 align-self-center">
                        ...
                        <nav aria-label="breadcrumb" class="mt-2 float-md-right float-left">
                            <ol class="breadcrumb mb-0 justify-content-end p-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Add Construction</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="page-content container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form enctype="multipart/form-data" method="post" action="{{ url('/admin/create-construction') }}" name="add_construction" id="add_construction"> {{ csrf_field() }}
                                    <div class="form-body">
                                        <h5 class="card-title">About Construction</h5>
                                        <hr>
                                        <div class="row">
                                            <div class="col-md-6">
                                    ...
                                    <div class="form-actions mt-5">
                                        ...
                                        <a href="{{ url('/admin/view-construction')}}"><button type="button" class="btn btn-dark">Cancel</button></a>
                                    </div>
                                </form>
                            </div>
                        </div>
