                                        ...
                                        @foreach($db_wp_orders as $order)
                                            <tr>
                                                ...
                                                <td style="width: 15%">
                                                    ...
                                                    @if($order->location_status != 4)
                                                    <button type="button" class="btn waves-effect waves-light btn-primary"><a class="text-white" href="{{ url('transport/complete-wp-order/'.$order->id) }}">Deliverd?</a></button>
                                                    @else
                                                    <button type="button" class="btn waves-effect waves-light btn-primary"><a class="text-white" href="{{ url('transport/assign-order/'.$order->id) }}">Assign</a></button>
                                                    @endif
