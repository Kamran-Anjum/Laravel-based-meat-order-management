            ...
            <div class="page-content container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form enctype="multipart/form-data" method="post" action="{{ url('/transport/assign-order/'.$sale_order->id) }}" > {{ csrf_field() }}
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" disabled class="form-control" value="{{$sale_order->status}}">
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                    ...
                                    <div class="form-actions mt-5">
                                        ...
                                        <a href="{{ url('/transport/view-wp-orders')}}"><button type="button" class="btn btn-dark">Cancel</button></a>
                                    </div>
                                </form>
                            </div>
                        </div>
