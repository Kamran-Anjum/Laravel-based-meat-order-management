                    ...
                    <div class="col-lg-9 col-md-8 col-xs-12 align-self-center">
                        ...
                        <nav aria-label="breadcrumb" class="mt-2 float-md-right float-left">
                            <ol class="breadcrumb mb-0 justify-content-end p-0">
                                <li class="breadcrumb-item"><a href="{{ url('production/dashboard') }}">Home</a></li>
            ...
            <div class="page-content container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form enctype="multipart/form-data" method="post" action="{{ url('/production/create-order') }}" name="add_subcategory" id="add_category"> {{ csrf_field() }}
                                    <div class="form-body">
                                    ...
                                    <table  class="table table-striped border">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="width: 15%">
                                                    <select disabled required id="category" class="form-control">
                                                        {!! $categories_dropdown !!}
                                                    </select>  
                                         		</td>

                                         		<td style="width: 15%">
                                                    <select disabled required id="sub_category" class="form-control">
                                                    </select> 
                                         		</td>
                                         		<td style="width: 15%">
                                                    <select disabled required id="product_id" class="form-control">
                                                    </select> 
                                ...
                                <hr>
                                    ...
                                    <div class="form-actions mt-5">
                                        ...
                                        <a href="{{ url('/production/view-orders')}}"><button type="button" class="btn btn-dark">Cancel</button></a>
                                    </div>
                                </form>
                            </div>
                        </div>
